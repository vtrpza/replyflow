  ...
  return (
    <footer className="border-t border-[var(--rf-border)]">
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="mt-8 pt-6 border-t border-[var(--rf-border)]/60 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 text-xs font-medium text-zinc-400 hover:text-emerald-400/90 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 rounded"
          >
            <svg
