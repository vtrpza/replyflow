...
const messages: Record<Locale, Record<string, string>> = {
  "pt-BR": {
    ...
    "sidebar.syncLimitReached": "Limite diario de sincronizacao atingido. Faca upgrade para Pro.",
  ...
  en: {
    ...
    "sidebar.syncLimitReached": "Daily sync limit reached. Upgrade to Pro.",
